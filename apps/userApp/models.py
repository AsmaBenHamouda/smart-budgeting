...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def username(self):
        """
        Propriété de compatibilité pour le code qui utilise username.
        Retourne le prénom ou l'email si le prénom est vide.
        """
        return self.firstname or self.email.split('@')[0] if self.email else 'user'
